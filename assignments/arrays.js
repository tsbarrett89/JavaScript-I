...
function carInfo (idNum){
  return 'Car ' + idNum + ' is a ' + inventory[idNum -1].car_year + ' '  + inventory[idNum -1].car_make + ' ' + inventory[idNum -1].car_model + '.'
}
